...

{
  ...
  assert.match(css, /\.gate-tap[\s\S]{0,480}color:\s*#F4DC8A/);
  ...
  assert.match(css, /\.names small[\s\S]{0,160}font-size:\s*1\.5rem/);
  assert.match(css, /\.names small[\s\S]{0,280}-webkit-text-stroke/);
